...
- или так
- SELECT * FROM payment WHERE payment_date BETWEEN STR_TO_DATE ('2005-06-15 00:00:00', '%Y-%m-%d %H:%i:%s') AND STR_TO_DATE ('2005-06-18 23:59:59', '%Y-%m-%d %H:%i:%s') AND amount > 10.00;

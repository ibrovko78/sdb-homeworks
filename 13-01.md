...
---
- если опираться на сайт https://www.exploit-db.com/ , то найдены следующие уязвимоти
- PORT     STATE SERVICE     VERSION
- 21/tcp   open  ftp         vsftpd 2.3.4 | https://www.exploit-db.com/exploits/17491
- 25/tcp   open  smtp        Postfix smtpd| https://www.exploit-db.com/exploits/48185
- 53/tcp   open  domain      ISC BIND 9.4.2 | https://www.exploit-db.com/exploits/6122
...
```
- а если по факту, но вот несколько уязвимостей
